...
// UpperString returns the upper case string representation of the log level
func (l Level) UpperString() string {
	return strings.ToUpper(l.String())
}

// LowerString returns the lower case string representation of the log level
...
// UnmarshalJSON unmarshals the JSON representation of the log level
